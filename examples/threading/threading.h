...
struct thread_data{
     ...
     */
    bool thread_complete_success; // thread completion
    useconds_t wait_to_obtain_ms; // time to wait before locking mutex
    useconds_t wait_to_release_ms; // time to wait before unlocking mutex
